...
function generateData() {
    ...
    // Strictly additive: if there are no local media folders (e.g. running in
    // CI where media lives on R2), keep the committed data.js untouched.
    // Overwriting with {} would wipe out the baked portfolio data.
    if (Object.keys(portfolioData).length === 0) {
        console.log('⚠ No local media folders found — keeping existing data.js.');
        return;
    }

    const output = `// Auto-generated by sync.cjs\n// DO NOT EDIT THIS FILE MANUALLY\nexport const portfolioData = ${JSON.stringify(portfolioData, null, 2)};\nexport const globalLatestFileTime = ${globalLatestTime};`;
